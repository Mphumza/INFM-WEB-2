...
namespace INFM_WEB_2.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Supplier_Id,SupplierName,Address,City,Province,PostalCode,Email,Phone,ContactPerson")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Supplier_Id,SupplierName,Address,City,Province,PostalCode,Email,Phone,ContactPerson")] Supplier supplier)
        {
        ...
        {
          return (_context.Suppliers?.Any(e => e.Supplier_Id == id)).GetValueOrDefault();
        }
    }
}
